<!-- Ajout d'une nouvelle ligne dans table 'category' -->
...
@section('add_category')
    ...
    <div class="container-fluid">
        <form action="{{route('admin.post.add.category')}}" method="POST">
            ...
            <input type="submit" name="submit" value="Ajouter Catégorie" style="height: 50px; padding: 10px; background-color: green; color: white;">
        </form>
    </div>
